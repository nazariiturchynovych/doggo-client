...
export const Schedule: React.FC = () => {
  ...
  return (
    <div className="m-5 flex h-full flex-col rounded-xl border">
      <header className="flex items-center justify-between border-b border-gray-300 bg-gray-100 px-6 py-4">
        <div>
