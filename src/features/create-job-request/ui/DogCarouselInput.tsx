      ...
      <CarouselContent className={'h-full'}>
        {dogs.map((dog) => (
          <CarouselItem key={dog.id.toString()} className="h-full">
            <div className="h-full rounded-md p-4 shadow-md">
              <div className="relative flex h-full min-w-60 flex-col items-center justify-center gap-5 rounded-md border-2 border-primary p-3">
